...
// // Интерфейс для типизации состояния ошибок
// interface ErrorState {
//   [key: string]: string;
// }

// // Функции валидации
// const validateInput = (value: string): boolean => value.trim() !== '';
...
//     setErrors({ ...errors, [id]: '' }); // Сброс ошибки при изменении содержимого поля
//   };
...
//         newErrors = { ...newErrors, [input.id]: !validatePhoneNumber(input.value) ? 'Введите корректный номер телефона' : '' };
//       } else {
//         newErrors = { ...newErrors, [input.id]: !validateInput(input.value) ? 'Заполните это поле' : '' };
//       }
//     });
