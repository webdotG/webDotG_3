          ...
          <div className={styles['password-wrapper']} >
            ...
            <div className={styles['password-input_wrapper']}>
              ...
              <button className={styles['btn-show-password']} type="button" onClick={handleTogglePassword}>
                {showPassword
                  ? (<svg className={styles['open-eye']} fill='none' strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path d="M4.5 8C7.5 14.5 16.5 14.5 19.5 8"  strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M16.8162 11.3175L19.5 15"  strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M12 12.875V16.5"  strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M7.18383 11.3175L4.5 15"  strokeLinecap="round" strokeLinejoin="round" />
                  </svg>)
                  : (<svg
                    className={styles['close-eye']}
                    id="Layer_1"
                    version="1.1"
                    viewBox="0 0 80 80"
                    xmlSpace="preserve"
