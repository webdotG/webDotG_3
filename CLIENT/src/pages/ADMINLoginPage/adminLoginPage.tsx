...
import style from './adminLoginPagw.module.scss'
  ...
  return (
    <div className={style['page-container']}>
      ...
      <div className={style['admin']}>
        ...
        <form className={style['login-form']} onSubmit={(e) => handleSubmit(e, user)}>
          <div className={style['email-wrapper']}>
            ...
            <input
              ...
              onBlur={handleBlur}
              className={`${error.email ? style.error : ''} ${style['email-input']}`}
            />
          ...
          <div className={style['password-wrapper']} >
            ...
            <div className={style['password-input_wrapper']}>
              <input
                ...
                onChange={handleChange}
                onBlur={handleBlur}
                className={`${error.email ? style.error : ''} ${style['password-input']}`}
              />
              <button className={style['btn-show-password']} type="button" onClick={handleTogglePassword}>
                {showPassword
            ...
            {error.password && <p className={style['error-message']}>{error.password}</p>}
          </div>
          <button disabled={!!(error.email || error.password)} type="submit" className={style['submit-button']}>Войти</button>
        </form>
